...
const getAllPossibleTurnOutcomesForCurrentPlayer = (game) => {
...
const isPlayerStuck = ramda_1.curry((game) => ramda_1.isEmpty(getAllPossibleTurnOutcomesForCurrentPlayer(game)));
